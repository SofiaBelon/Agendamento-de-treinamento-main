...
public class AgendamentoController {
  ...
  public void excluirAgendamento(@PathVariable Integer id) {
   ...
   @GetMapping("/agendamentos-between/{dataInicio}/{dataFim}/{professorid}")
  public List<AgendamentoDTO> getAgendamentosBetweenDates(
    ...
    List<Agendamento> agendamentos = agendamentoService.findAgendamentosBetweenDates(dataInicio, dataFim, professorid);
